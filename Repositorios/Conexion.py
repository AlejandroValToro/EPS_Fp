...
# Modelos ORM que mapean las tablas de la base de datos
...
# Repositorios para operaciones CRUD usando Stored Procedures

class RepositorioBase:
    """
    Clase base para todos los repositorios.
    Implementa operaciones CRUD genéricas usando stored procedures.
    """
    ...
    def _map_result(self, result):
        """Convierte resultados de la BD al modelo ORM"""
